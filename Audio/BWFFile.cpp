...
public:
  ...
  bool big_endian_ {false};       // Qt6 QAudioFormat dropped byte-order tracking; kept here
  int bits_per_sample_ {16};      // Qt6 QAudioFormat dropped sampleSize(); kept here
  QFile file_;
  QByteArray bext_;
                  ...
                  if (!memcmp (&wave_desc.id_, "fmt ", 4))
                    {
                      ...
                      format_.setSampleFormat (8 == bits_per_sample ? QAudioFormat::UInt8 : 32 == bits_per_sample ? QAudioFormat::Int32 : QAudioFormat::Int16);
                    }
